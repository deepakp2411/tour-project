          ...
          {tour.map((data) => (
            <div key={data.id}>
              ...
              <div className="flex justify-around items-center">
                <h3 className="cursor-pointer font-bold">{data.title}</h3>
                <h3 className="cursor-pointer font-bold">{data.price}</h3>
              </div>
            </div>
          ))}
        </Carousel>
      ...
      <div className="mt-[20vh]">
        <div className="flex justify-between items-center ">
          ...
          <div className="self-baseline mt-3 pr-[15vw] md:justify-center">
            <h1 className="text-center font-bold text-3xl mt-1">
              Get ready for real time adventure
            </h1>
            <p className="italic mt-2 indent-1 ">
            ...
            <div className="flex justify-center items-center ml-[10vw] mt-10 rounded bg-blue-600 w-[10vw] h-[5vh] hover:bg-sky-700">
